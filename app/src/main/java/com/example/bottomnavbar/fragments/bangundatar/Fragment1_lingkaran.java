...
public class Fragment1_lingkaran extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment1_lingkaran, container, false);
        ...
        JariJariField = rootView.findViewById(R.id.input_sisi);
        ...
        calcButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!JariJariField.getText().toString().isEmpty()) {
                    ...
                    double hasil = Math.PI * Math.pow(InputRusuk, 2);
