...
public class Fragment1_segitiga extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment1_segitiga, container, false);
        ...
        calcButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!AlasField.getText().toString().isEmpty() && !TinggiField.getText().toString().isEmpty()) {
                    ...
                    int hasil = (InputAlas * InputTinggi) / 2;
