...
public class Fragment2_balok extends Fragment {

    Button backButton;
    Button calcButton;
    EditText PanjangField;
    EditText LebarField;
    EditText TinggiField;
    TextView Hasil;

    public Fragment2_balok() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment2_balok, container, false);
        ...
        PanjangField = rootView.findViewById(R.id.input_panjang);
        LebarField = rootView.findViewById(R.id.input_lebar);
        ...
        calcButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!PanjangField.getText().toString().isEmpty() && !LebarField.getText().toString().isEmpty() && !TinggiField.getText().toString().isEmpty()) {
                    Toast.makeText(requireContext(), "Luas telah dihitung!", Toast.LENGTH_SHORT).show();
                    int InputPanjang = Integer.parseInt(PanjangField.getText().toString());
                    int InputLebar = Integer.parseInt(LebarField.getText().toString());
                    int InputTinggi = Integer.parseInt(TinggiField.getText().toString());
                    int hasil = InputPanjang * InputLebar *  InputTinggi;
